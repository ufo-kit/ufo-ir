...
#define UFO_IR_STATE_DEPENDENT_TASK(obj)             (G_TYPE_CHECK_INSTANCE_CAST((obj), UFO_IR_TYPE_STATE_DEPENDENT_TASK, UfoIrStateDependentTask))
#define UFO_IR_IS_STATE_DEPENDENT_TASK(obj)          (G_TYPE_CHECK_INSTANCE_TYPE((obj), UFO_IR_TYPE_STATE_DEPENDENT_TASK))
#define UFO_IR_STATE_DEPENDENT_TASK_CLASS(klass)     (G_TYPE_CHECK_CLASS_CAST((klass), UFO_IR_TYPE_STATE_DEPENDENT_TASK, UfoIrStateDependentTaskClass))
#define UFO_IR_IS_STATE_DEPENDENT_TASK_CLASS(klass)  (G_TYPE_CHECK_CLASS_TYPE((klass), UFO_IR_TYPE_STATE_DEPENDENT_TASK))
#define UFO_IR_STATE_DEPENDENT_TASK_GET_CLASS(obj)   (G_TYPE_INSTANCE_GET_CLASS((obj), UFO_IR_TYPE_STATE_DEPENDENT_TASK, UfoIrStateDependentTaskClass))
