...
#define UFO_IR_IS_METHOD_TASK_NODE(obj)          (G_TYPE_CHECK_INSTANCE_TYPE((obj), UFO_IR_TYPE_METHOD_TASK_NODE))
...
#define UFO_IR_IS_METHOD_TASK_NODE_CLASS(klass)  (G_TYPE_CHECK_CLASS_TYPE((klass), UFO_IR_TYPE_METHOD_TASK_NODE))
